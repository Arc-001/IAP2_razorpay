    ...
    >
      ...
      <div class="flex gap-2">
        <button
          ...
          :class="role === 'customer' ? 'border-indigo-600 bg-indigo-600 text-white' : 'border-slate-300 text-slate-600'"
          @click="role = 'customer'"
        >
          Customer
        </button>
        <button
          type="button"
          class="flex-1 rounded-md border px-3 py-1.5 text-sm"
          :class="role === 'merchant' ? 'border-indigo-600 bg-indigo-600 text-white' : 'border-slate-300 text-slate-600'"
          @click="role = 'merchant'"
        >
          Merchant
        </button>
